...
@section('titulo')
<h1>PROCESOS DE GESTION  </h1>
@endsection
@Section('contenido')
<span class="image main"><img src="images1/business-gb58eeaa16_1280.png" alt="" /></span>
							...
							<h2>GESTION DE ADMINISTRACION DE PROCESOS DE SERVICIO </h2>
							<p><span class="image left">
								<img src="images1/descargar (5).png" alt="" />
							</span>
							<p>
...
De acuerdo a la gestión, se considera al servicio como un eslabón de la cadena de suministro que (junto a otros como el control de calidad y procesos de venta) ayuda a conservar a los clientes. Por eso necesita valerse de herramientas que permitan automatizar aspectos como el control de inventario, fluidez en las entregas de artículos, registro de devoluciones o mercancía dañada e incluso las comunicaciones que se tienen con un cliente en particular hasta el momento.
							...
							<br><br><h2>GESTION DE ADMINISTRACION DE SUPERVISION  </h2>
							<p><span class="image right">
								<img src="images1/HOLA.jpeg" alt="" />
							</span>
							<p>
								La supervisión es una actividad técnica y especializada que tiene como fin fundamental utilizar
racionalmente los factores que le hacen posible la realización de los procesos de trabajo: el hombre,
la materia prima, los equipos, maquinarias, herramientas, dinero, entre otros elementos que en forma
directa o indirecta intervienen en la consecución de bienes, servicios y productos destinados a la
satisfacción de necesidades de un mercado de consumidores, cada día más exigente, y que mediante
su gestión puede contribuir al éxito de la empresa.
							
							
							</p>
							<br><br><h2>GESTION DE REDISTRIBUCION DE LAS CARGAS DE TRABAJO  </h2>
							<p><span class="image left">
								<img src="images1/descargar (6).png" alt="" />
							</span>
							<p>
								
								Se trata de que cada colaborador tenga la posibilidad de:

								influir y tomar decisiones en la realización de sus actividades, con base en sus conocimientos y habilidades
								actuar con cierta autonomía o tomando la iniciativa
								participar y manejar los cambios, y
								aportar soluciones para crear mejores formas de trabajo y un entorno organizacional favorable					</p>
						</p>
						<br><br><h2>GESTION DE TRANSACCIONES  </h2>
						<p><span class="image right">
							<img src="images1/descargar 7.jpeg" alt="" />
						</span>
						<p>
							
							La gestión de transacciones trata el problema de
asegurar la bd en un estado consistente aún en
casos de acceso concurrente y de fallas.


						</p>
						<br><br><h2>GESTION DE COMUNICACIONES  </h2>
						<p><span class="image left">
							<img src="images1/descargar (7).png" alt="" />
						</span>
						<p>
							
							Se trata del proceso de desarrollar un enfoque y un plan apropiados para las actividades de comunicación del proyecto basados en las necesidades de información de cada interesado o grupo, en los activos de la organización disponibles y en las necesidades del proyecto.
...
<br><br><h2>CONTROL DE CONCURRENCIA  </h2>
						<p><span class="image right">
							<img src="images1/CONCURRENCIA.jpeg" alt="" />
						</span>
						<p>
